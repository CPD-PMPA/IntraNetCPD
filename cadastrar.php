<?php
    ...
    $sql = 'INSERT INTO `abertura_chamado` (nome, matricula, telefone, secretaria, descricao, tipo_chamado) VALUES (:nome, :matricula, :telefone, :secretaria, :descricao, :tipo_chamado)';                                      
    $e = $pdo->prepare($sql);
    ...
    echo("Seu chamado foi aberto com sucesso! Aguarde nossa equipe verificar e tomar providências!");